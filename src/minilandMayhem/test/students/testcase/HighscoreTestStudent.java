...
public class HighscoreTestStudent {
	...
	public void testScore() {
		...
		assertTrue("Mario did not collect Coin",adapter.getScore() == 1490);
		adapter.updateGame(500);
		assertTrue("Destruction of Mario does not subtract correct amount of points",adapter.getScore() == 990);
	}
}
